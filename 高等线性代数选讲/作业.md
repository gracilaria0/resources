...
$$\begin{array}{rcl}
	...
	&=& \overline{\left(\boldsymbol{\beta},\boldsymbol{e}_1\right)}\left(\left(\left(\boldsymbol{\alpha},\boldsymbol{e}_1\right)\boldsymbol{e}_1,\boldsymbol{e}_1\right) + \left(\left(\boldsymbol{\alpha},\boldsymbol{e}_2\right)\boldsymbol{e}_2,\boldsymbol{e}_1\right) + \cdots + \left(\left(\boldsymbol{\alpha},\boldsymbol{e}_n\right)\boldsymbol{e}_n,\boldsymbol{e}_1\right)\right) \\
